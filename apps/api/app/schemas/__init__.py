...
from app.schemas.investigation import InvestigationBase, InvestigationCreate, InvestigationResponse
...
__all__ = [
    ...
    "InvestigationBase", "InvestigationCreate", "InvestigationResponse",
